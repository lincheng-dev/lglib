...
class ArbitrageScanner:
    ...
    def scan_detail(self, *args, **kwargs):
        ...
        if len(arbitrageDFs) > 0:
            ...
            arbiTitle      = "%s arbitrage scan with threshold %s" % (now.strftime("%Y%m%d %H:%M:%S"), str(threshold).replace('.',''))
            send_mail(["gonglch@gmail.com", "irving02@gmail.com"], arbiTitle, arbiHTML, "Structured Fund Scan")
